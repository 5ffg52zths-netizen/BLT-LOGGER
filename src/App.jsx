...
function AppInner() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#071018", fontFamily: "'Noto Sans JP', Inter, sans-serif", color: C.text, paddingBottom: page === "menu" ? "0px" : "80px" }}>
      ...
      <div style={{ background: "linear-gradient(180deg,rgba(7,16,26,0.92) 0%,transparent 100%)", padding: "calc(16px + env(safe-area-inset-top, 0px)) 16px 12px", display: "flex", alignItems: "center", gap: "10px", position: "sticky", top: 0, zIndex: 50, backdropFilter: "blur(12px)" }}>
        {page !== "menu" && (
